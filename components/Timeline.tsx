...
const Timeline = () => {
  return (
    <div className="hero min-h-screen bg-[#A5C9CA] lg:bg-[#9abec0] justify-start">
  ...
  <li>
    ...
    <div className="timeline-end "><Certification /></div>
    <hr/>
  </li>
  <li>
    <hr/>
  ...
  <li>
    ...
    <div className="timeline-end "><ProjectcontSSS/></div>
  </li>
</ul>
  {/* </div> */}
</div>
